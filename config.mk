...
# Stockrom dirs
STOCKROM_SYS_DIR := $(STOCKROM_DIR)/system
STOCKROM_JAR_DIR := $(STOCKROM_SYS_DIR)/framework
STOCKROM_APP_DIR := $(STOCKROM_SYS_DIR)/app
STOCKROM_PRIV_APP_DIR := $(STOCKROM_SYS_DIR)/priv-app
STOCKROM_BIN_DIR := $(STOCKROM_SYS_DIR)/bin
STOCKROM_XBIN_DIR := $(STOCKROM_SYS_DIR)/xbin
STOCKROM_LIB_DIR := $(STOCKROM_SYS_DIR)/lib
STOCKROM_LIB64_DIR := $(STOCKROM_SYS_DIR)/lib64
STOCKROM_ETC_DIR := $(STOCKROM_SYS_DIR)/etc
STOCKROM_MEDIA_DIR := $(STOCKROM_SYS_DIR)/media
STOCKROM_FONTS_DIR := $(STOCKROM_SYS_DIR)/fonts
