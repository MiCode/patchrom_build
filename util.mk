usage:
	...
	@echo "	make -e otabase=xxx zipfile-and-ota  - create the zipfile and the ota package based on xxx"
	@echo "	make -e otabase=xxx zipfile-ota      - create the ota package based on xxx"
...
use_previous_target_file  := $(local-previous-target-dir)/target_file.$(otabase).zip
zipfile-ota: $(TMP_DIR)/target_files.zip $(use_previous_target_file)
	$(TOOL_DIR)/releasetools/ota_from_target_files -k ../build/security/testkey -i $(use_previous_target_file) $(TMP_DIR)/target_files.zip $(TMP_DIR)/ota_update_$(otabase).zip
	@echo OTA package generated at: $(TMP_DIR)/ota_update_$(otabase).zip
...
$(use_previous_target_file):
	...
	$(error need to specify the build number as ota base: make -e otabase=xxx zipfile-ota)
